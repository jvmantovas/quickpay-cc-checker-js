...
const ccBgColor01 = document.querySelector(".cc-bg svg g > path");
const ccBgColor02 = document.querySelector(".cc-bg svg g > path");
...
function setCardType(type) {
  ...
  ccBgColor01.setAttribute("stroke", colors[type][0]);
  ccBgColor02.setAttribute("stroke", colors[type][1]);
